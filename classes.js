...
class Machine {
  ...
  makeWidgets(num){
    ...
    this.fifty_created_counter += num
    
    if(this.fifty_created_counter >= 50){
      let additional = this.fifty_created_counter % 50
      this.wear_and_tear_count += (this.fifty_created_counter - additional) / 50
      this.fifty_created_counter = additional
    }
  }
